...
- **Настроение / визуал** — *Osmos*, *Eufloria*: созерцательные «зен»-игры, в которые играют не спеша.
- **Геймплей / эволюция** — [*Thrive*](https://github.com/Revolutionary-Games/Thrive) — **открытая** игра про путь от микроба к многоклеточному и эволюцию. Близка по духу к нашей целевой эпохе «клетки → выживание → эволюция». Так как исходники открыты — полезный референс: можно посмотреть, как у них устроены химические реакции, метаболизм клетки, мутации и развитие организмов, и переиспользовать удачные решения по механикам.
