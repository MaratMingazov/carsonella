        ...
        DragDropContainer {
            Row(Modifier.fillMaxSize()) {
                ...
                RightPanel(
                    ...
                    onDrop = { data, localPos -> world.entityGenerator.createEntity(element = data.element, Position(localPos.x, localPos.y), direction = randomDirection(world.random), velocity = 0f, energy = 0f) },
                    hoverPos = hoverPos,
                    onHover = { hoverPos = it },
                    hoveredId = hoveredId,
