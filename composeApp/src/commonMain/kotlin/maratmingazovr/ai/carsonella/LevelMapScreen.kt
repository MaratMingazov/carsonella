...
/**
 * Карта заданий: узлы — задания, слой — глубина по зависимостям. Руками не рисуется: и узлы, и слои
 * выводятся из [LEVELS], поэтому карта показывает ровно то, что игра и запустит.
 *
 * Карточка двулика. Не пройдено — задание и эталон цели, но без имени: игра не называет молекулу до
 * того, как игрок её получил. Пройдено — имя того, что вышло. Закрыто — силуэт.
 */
@Composable
