...
import maratmingazovr.ai.carsonella.chemistry.molecules.DiHydrogen
...
class MoleculeGenerator(
    ...
    override fun createDiHydrogen(
        position: Position,
        direction: Vec2D,
        velocity: Float,
    ): Entity<*> {
        val diHydrogen = DiHydrogen(id = idGen.nextId(), position = position, direction = direction, velocity = velocity)
