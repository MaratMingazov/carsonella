...
val LEVELS = listOf(
    Level(LevelId.DIHYDROGEN, goalMoleculeId = MoleculeId.DIHYDROGEN, inventory = mapOf(atom(Element.HYDROGEN) to 2),
        task = Prose(
    ...
    Level(LevelId.HYDROXYL, goalMoleculeId = MoleculeId.HYDROXYL, inventory = mapOf(atom(Element.HYDROGEN) to 1, atom(Element.OXYGEN_16) to 1),
        task = Prose(
    ...
    Level(LevelId.WATER, goalMoleculeId = MoleculeId.WATER, inventory = mapOf(atom(Element.HYDROGEN) to 2, atom(Element.OXYGEN_16) to 1),
        task = Prose(
    ...
    Level(LevelId.DIOXYGEN, goalMoleculeId = MoleculeId.DIOXYGEN, inventory = mapOf(atom(Element.OXYGEN_16) to 2),
        task = Prose(
    ...
    Level(LevelId.PEROXIDE, goalMoleculeId = MoleculeId.HYDROGEN_PEROXIDE, inventory = mapOf(atom(Element.HYDROGEN) to 2, atom(Element.OXYGEN_16) to 2),
        task = Prose(
            ru = "Теперь давай попробуем построить перекись водорода",
            en = "Now let's try building hydrogen peroxide",
        )),
    Level(LevelId.PEROXIDE_SPLIT, goalMoleculeId = MoleculeId.HYDROXYL, inventory = mapOf(known(MoleculeId.HYDROGEN_PEROXIDE) to 1, atom(Element.PHOTON) to 3),
        task = Prose(
