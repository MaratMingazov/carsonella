                                ...
                                if (e.key == Key.Spacebar) {
                                    ...
                                    if (id != null && mouse != null) {
                                        ...
                                        if (selected != null) {
                                            ...
                                            world.entityGenerator.createEntity(element = selected.element, Position(selected.position.x, selected.position.y),  direction = dir, velocity = 10f, energy = selected.energy, environment = world.environment, electrons = selected.electrons)
                                        }
                                    }
                                }
                                true
