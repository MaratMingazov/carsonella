...
enum class MoleculeElement(val title: TranslatedText, val description: TranslatedText) : ElementOrMolecule {
    ...
    AMINOCARBENE(TranslatedText("Аминокарбен", "Aminocarbene"), TranslatedText(ru = "", en = "")),
    METHYLAMINYL(TranslatedText("Метиламинил", "Methylaminyl"), TranslatedText(ru = "", en = "")),
    METHYLAMINE(TranslatedText("Метиламин", "Methylamine"), TranslatedText(ru = "", en = "")),
