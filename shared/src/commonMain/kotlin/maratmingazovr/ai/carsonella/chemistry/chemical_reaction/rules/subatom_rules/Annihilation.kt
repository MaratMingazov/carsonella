...
class Annihilation(
    ...
    override fun matchesSubAtom(subAtom: SubAtom, neighbors: List<Entity>): MatchedData? {
        ...
        val positronPosition = subAtom.kinematics.position
    ...
    override fun produce(match: MatchedData): ReactionOutcome {
        ...
        val positronPosition = positronEntity.kinematics.position
        val electronPosition = electronEntity.kinematics.position
