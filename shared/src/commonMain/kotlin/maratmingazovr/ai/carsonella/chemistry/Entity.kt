...
enum class Element() {
    ...
    CARBON_12_ION_6,
    CARBON_12,
    OXYGEN_16_ION_8, OXYGEN_16_ION_7,
    O,
    NEON_20_ION_10,
    NA_23_ION_11,
    MG_24_ION_12,
    ...
    companion object {
        private val detailsMap: Map<Element, Details> = mapOf(
            ...
            OXYGEN_16_ION_7         to Details (type = ElementType.Atom, symbol = "O⁷⁺",       label = "Oxygen (¹⁶O⁷⁺)",       mass = 16f, e = 1, p = 8, n = 8,     description = "Кислород", energyLevels = listOf(871.41f)),
