...
enum class Element() {
    ...
    companion object {
        private val detailsMap: Map<Element, Details> = mapOf(
            ...
            BERYLLIUM_8_ION_4       to Details (type = ElementType.Atom, symbol = "⁸Be⁴⁺",     label = "Beryllium (⁸Be⁴⁺)",    mass = 8f, e = 0, p = 4, n = 4,      description = "Бериллий",   alphaGammaResult = CARBON_12_ION_6),
            CARBON_12_ION_6         to Details (type = ElementType.Atom, symbol = "C⁶⁺",       label = "Carbon (¹²C⁶⁺)",       mass = 12f, e = 0, p = 6, n = 6,     description = "Углерод",    alphaGammaResult = OXYGEN_16_ION_8),
