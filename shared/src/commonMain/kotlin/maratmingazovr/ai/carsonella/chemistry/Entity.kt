...
enum class Element() {
    ...
    companion object {
        private val detailsMap: Map<Element, Details> = mapOf(
            ...
            LITHIUM_7_ION_1         to Details (type = ElementType.Atom, symbol = "⁷Li¹⁺",     label = "Lithium (⁷Li¹⁺)",      mass = 7f, e = 2, p = 3, n = 4,      description = "Литий",      recombinationElement = LITHIUM_7,       energyLevels = listOf(75.6f),                   ion = LITHIUM_7_ION_2),
            ...
            OXYGEN_16_ION_6         to Details (type = ElementType.Atom, symbol = "O⁶⁺",       label = "Oxygen (¹⁶O⁶⁺)",       mass = 16f, e = 2, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_5,   energyLevels = listOf(739.29f),                 ion = OXYGEN_16_ION_7),
            OXYGEN_16_ION_5         to Details (type = ElementType.Atom, symbol = "O⁵⁺",       label = "Oxygen (¹⁶O⁵⁺)",       mass = 16f, e = 3, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_4,   energyLevels = listOf(138.12f),                 ion = OXYGEN_16_ION_6),
            OXYGEN_16_ION_4         to Details (type = ElementType.Atom, symbol = "O⁴⁺",       label = "Oxygen (¹⁶O⁴⁺)",       mass = 16f, e = 4, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_3,   energyLevels = listOf(113.9f),                  ion = OXYGEN_16_ION_5),
            OXYGEN_16_ION_3         to Details (type = ElementType.Atom, symbol = "O³⁺",       label = "Oxygen (¹⁶O³⁺)",       mass = 16f, e = 5, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_2,   energyLevels = listOf(77.41f),                  ion = OXYGEN_16_ION_4),
