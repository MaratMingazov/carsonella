...
enum class Element() {
    ...
    companion object {
        private val detailsMap: Map<Element, Details> = mapOf(
            ...
            HELIUM_4_ION_2          to Details (type = ElementType.Atom, symbol = "⁴He²⁺",     label = "Helium (⁴He²⁺)",       mass = 4f, e = 0, p = 2, n = 2,      description = "Гелий",      recombinationElement = HELIUM_4_ION_1,  alphaReactionResult = BERYLLIUM_8_ION_4),
            HELIUM_4_ION_1          to Details (type = ElementType.Atom, symbol = "⁴He¹⁺",     label = "Helium (⁴He¹⁺)",       mass = 4f, e = 1, p = 2, n = 2,      description = "Гелий",      recombinationElement = HELIUM_4,        energyLevels = listOf(54.42f)),
            HELIUM_4                to Details (type = ElementType.Atom, symbol = "⁴He",       label = "Helium (⁴He)",         mass = 4f, e = 2, p = 2, n = 2,      description = "Гелий",                                              energyLevels = listOf(24.59f)),
            ...
            LITHIUM_7_ION_2         to Details (type = ElementType.Atom, symbol = "⁷Li²⁺",     label = "Lithium (⁷Li²⁺)",      mass = 7f, e = 1, p = 3, n = 4,      description = "Литий",      recombinationElement = LITHIUM_7_ION_1, energyLevels = listOf(122.4f)),
            LITHIUM_7_ION_1         to Details (type = ElementType.Atom, symbol = "⁷Li¹⁺",     label = "Lithium (⁷Li¹⁺)",      mass = 7f, e = 2, p = 3, n = 4,      description = "Литий",      recombinationElement = LITHIUM_7,       energyLevels = listOf(75.6f)),
            LITHIUM_7               to Details (type = ElementType.Atom, symbol = "⁷Li",       label = "Lithium (⁷Li)",        mass = 7f, e = 3, p = 3, n = 4,      description = "Литий",                                              energyLevels = listOf(5.39f)),
            BERYLLIUM_7_ION_4       to Details (type = ElementType.Atom, symbol = "⁷Be⁴⁺",     label = "Beryllium (⁷Be⁴⁺)",    mass = 7f, e = 0, p = 4, n = 3,      description = "Бериллий"),
            ...
            NITROGEN_15_ION_7       to Details (type = ElementType.Atom, symbol = "¹⁵N⁷⁺",     label = "Nitrogen (¹⁵N⁷⁺)",     mass = 15f, e = 0, p = 7, n = 8,     description = "Азот",       alphaReactionResult = FLUORINE_19_ION_9),
            ...
            OXYGEN_16_ION_8         to Details (type = ElementType.Atom, symbol = "O⁸⁺",       label = "Oxygen (¹⁶O⁸⁺)",       mass = 16f, e = 0, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_7, alphaReactionResult = NEON_20_ION_10),
            ...
            OXYGEN_16_ION_5         to Details (type = ElementType.Atom, symbol = "O⁵⁺",       label = "Oxygen (¹⁶O⁵⁺)",       mass = 16f, e = 3, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_4,   energyLevels = listOf(138.12f)  ),
            OXYGEN_16_ION_4         to Details (type = ElementType.Atom, symbol = "O⁴⁺",       label = "Oxygen (¹⁶O⁴⁺)",       mass = 16f, e = 4, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_3,   energyLevels = listOf(113.9f)   ),
            OXYGEN_16_ION_3         to Details (type = ElementType.Atom, symbol = "O³⁺",       label = "Oxygen (¹⁶O³⁺)",       mass = 16f, e = 5, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_2,   energyLevels = listOf(77.41f)   ),
            OXYGEN_16_ION_2         to Details (type = ElementType.Atom, symbol = "O²⁺",       label = "Oxygen (¹⁶O²⁺)",       mass = 16f, e = 6, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16_ION_1,   energyLevels = listOf(54.94f)   ),
            OXYGEN_16_ION_1         to Details (type = ElementType.Atom, symbol = "O¹⁺",       label = "Oxygen (¹⁶O¹⁺)",       mass = 16f, e = 7, p = 8, n = 8,     description = "Кислород", recombinationElement = OXYGEN_16,         energyLevels = listOf(35.12f)   ),
            OXYGEN_16               to Details (type = ElementType.Atom, symbol = "O",         label = "Oxygen (¹⁶O)",         mass = 16f, e = 8, p = 8, n = 8,     description = "Кислород",                                           energyLevels = listOf(13.6f)    ),
            ...
            MG_24_ION_12            to Details (type = ElementType.Atom, symbol = "Mg¹²⁺",     label = "Magnesium (²⁴Mg¹²⁺)",  mass = 24f, e = 0, p = 12, n = 12,   description = "Магний",     alphaReactionResult = SILICON_28_ION_14),
            ...
            CHROMIUM_48_ION_24      to Details (type = ElementType.Atom, symbol = "⁴⁸Cr²⁴⁺",   label = "Chromium (⁴⁸Cr²⁴⁺)",   mass = 48f, e = 0, p = 24, n = 24,   description = "Хром",       betaPlusDecayResult = VANADIUM_48_ION_23, alphaReactionResult = IRON_52_ION_26),
            ...
            IRON_52_ION_26          to Details (type = ElementType.Atom, symbol = "⁵²Fe²⁶⁺",   label = "Iron (⁵²Fe²⁶⁺)",       mass = 52f, e = 0, p = 26, n = 26,   description = "Железо",     betaPlusDecayResult = MANGANESE_52_ION_25, alphaReactionResult = NICKEL_56_ION_28),
