...
internal val MOLECULE_FACTS: Map<KnownMoleculeId, Description> = mapOf(
    KnownMoleculeId.DIHYDROGEN to Description(
    ...
    KnownMoleculeId.DIOXYGEN to Description(
    ...
    KnownMoleculeId.HYDROXYL to Description(
    ...
    KnownMoleculeId.WATER to Description(
    ...
    KnownMoleculeId.HYDROGEN_PEROXIDE to Description(
