...
internal val MOLECULE_FACTS: Map<KnownMoleculeId, TranslatedText> = mapOf(
    KnownMoleculeId.DIHYDROGEN to TranslatedText(
    ...
    KnownMoleculeId.DIOXYGEN to TranslatedText(
    ...
    KnownMoleculeId.HYDROXYL to TranslatedText(
    ...
    KnownMoleculeId.WATER to TranslatedText(
    ...
    KnownMoleculeId.HYDROGEN_PEROXIDE to TranslatedText(
